Source code of the [https://shefesh.com](ShefESH website) (or at least the 2025-present incarnation of it). The site is written using Nanoc, a Ruby framework for static site generation.
